...
public class MechaMeleeAttackGoal extends Goal {
    public final BaseArmorEntity baseArmorEntity;

    public MechaMeleeAttackGoal(BaseArmorEntity mob) {
    ...
    protected double getAttackReachSqr(LivingEntity p_25556_) {
        return (double) (this.baseArmorEntity.getBbWidth() * 2.0F * this.baseArmorEntity.getBbWidth() * 2.0F + p_25556_.getBbWidth());
    }
}
