...
public class SoulArmorModel<T extends SoulFireArmorEntity> extends HierarchicalModel<T> {
	...
	public SoulArmorModel(ModelPart root) {
		this.root = root;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition burnin = body.addOrReplaceChild("burnin", CubeListBuilder.create().texOffs(0, 22).addBox(3.5F, -3.0F, 0.0F, 2.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(0, 12).addBox(-5.5F, -3.0F, 0.0F, 2.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(55, 32).addBox(4.0F, 2.0F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(55, 32).addBox(-5.0F, 2.0F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 5.0F, 0.2182F, 0.0F, 0.0F));

		PartDefinition Bone = body.addOrReplaceChild("Bone", CubeListBuilder.create().texOffs(0, 41).addBox(-2.0F, -3.5F, -4.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(0, 41).addBox(1.0F, -3.5F, -4.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(0, 40).addBox(-6.0F, -5.0F, 2.0F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(0, 40).addBox(-6.0F, -4.5F, -2.0F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(0, 40).addBox(6.0F, -4.5F, -2.0F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(0, 40).addBox(6.0F, -5.0F, 2.0F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(0, 41).addBox(4.0F, -4.0F, -3.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(0, 41).addBox(4.0F, -6.0F, 4.0F, 1.0F, 3.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(0, 41).addBox(-5.0F, -6.0F, 4.0F, 1.0F, 3.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(0, 41).addBox(-5.0F, -4.0F, -3.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(0, 41).addBox(1.0F, -7.0F, 5.0F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(0, 41).addBox(-2.0F, -7.0F, 5.0F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = RightHand.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(56, 38).addBox(-4.0F, -6.0F, 0.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6109F, 0.0F, 0.0F));

		PartDefinition cube_r5 = RightHand.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(56, 38).addBox(-4.0F, -6.0F, -2.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r6 = Lefthand.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(56, 38).addBox(2.0F, -6.0F, 0.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.0F, 0.0F, 0.0F, -0.6109F, 0.0F, 0.0F));

		PartDefinition cube_r7 = Lefthand.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(56, 38).addBox(2.0F, -6.0F, -2.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.0F, 0.0F, 0.0F, 0.6109F, 0.0F, 0.0F));
